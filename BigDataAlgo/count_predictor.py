...
c=0
a={"Chest Pain":"Chest Pain","Heart failure and shock w MCC":"Heart failure","Major joint replacement or reattachment of lower extremity w/o MCC":"Joint replacement","Simple pneumonia and pleurisy w MCC":"Pneumonia","Chronic obstructive pulmonary disease w CC":"Lung disease","Revision of hip or knee replacement w CC":"Knee/Hip replacement"}
...
for key in historical_cost.keys():
	...
	print "\"id\":","\"",a[key],"\"",",","\"value\":",float(predictions[0]),
	if c<5:
		print "},{"
	else:
		print "}]"
